<template>
  <v-container>
    <v-card class="mx-auto my-2 justify-center elevation-0" max-width="1300px">
      ...
      <v-row>
          ...
          <v-row justify="end">
            <v-dialog v-model="dialogEditUser" persistent max-width="600px">
              <template v-slot:activator="{ on, attrs }">
                <v-icon class="pl-10" small color="#666666">
                  mdi-account-edit
                </v-icon>
                <v-btn
                  class="px-0"
        ...
        <v-spacer></v-spacer>
        <v-btn color="indigo" class="mr-4" text @click="logout">Log Out</v-btn>
      </v-row>
